...
//     : null;
  ...
  const filteredData = jobLists.filter((item) => item.serviceType.toLowerCase().includes(searchTerm.toLowerCase()));
  useEffect(() => {
    getAllTask();
  }, []);
  ...
  return (
    <>
      ...
      <div className="flex justify-evenly">
        ...
        <div className="w-1/4">
          {selectedJob !== null && jobLists.length > 0 && selectedJob < jobLists.length && (
              ...
              <div>
                <div>
                  ...
                  <div className="my-8">
                    ...
                    <div className="mt-1">
                      Optional Details: {jobLists[selectedJob].optionalDetails}
                    </div>
                    <div className="mt-1">
                      Name: {jobLists[selectedJob].nickname}
                    </div>
                    <div className="mt-1">
                      Additional Info: {jobLists[selectedJob].additionalInfo}
                    </div>
